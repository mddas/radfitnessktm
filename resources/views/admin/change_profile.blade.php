                    ...
                    <div class="box-header">
                        ...
                        <div class="col-sm-9">
                            ...
                            @if(Session::has('error'))
                                <div class="alert alert-danger alert-dismissible col-sm-9 col-sm-offset-2 hide"
                                     role="alert">
                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span
                                                aria-hidden="true">×</span></button>
                                    {{Session::get('error')}}
                        ...
                        <!--//error shows-->
                            ...
                            @if(Session::has('success'))
                                <div class="alert alert-success alert-dismissible col-sm-9 col-sm-offset-2 hide"
                                     role="alert">
                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span
                                                aria-hidden="true">×</span></button>
                                    {{Session::get('success')}}
                    ...
                    <div class="box-body">
                        <form method="post" action="{{route('admin.update_profile')}}">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="name" class="form-control" value="{{$change_profile->name}}"
                                       required/>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="email">Email <i class="reqr">*</i></label>
                                <input type="email" name="email" class="form-control"
                                       value="{{$change_profile->email}}"/>
                            </div>
                            <div class="col-md-12 reqr" id="msg_err"></div>

                            <div class="form-group col-md-6">
                                <label for="curr_password">Current Password <i class="reqr">*</i> <i
                                            class="fa fa-info-circle" title="Need to Save Profile"></i></label>
