...
class NavigationController extends Controller
{
    ...
    public function store(Request $request, $nav_category)
    {
        ...
        if ($request->hasFile('icon_image')) {
            ...
            $data['icon_image'] = str_replace(" ", "_", time() . '_' . $img_file->getClientOriginalName());
        ...
        if ($request->hasFile('featured_image')) {
            ...
            $data['featured_image'] = str_replace(" ", "_", time() . '_' . $img_file->getClientOriginalName());
        ...
        if ($request->hasFile('banner_image')) {
            ...
            $data['banner_image'] = str_replace(" ", "_", time() . '_' . $banner_file->getClientOriginalName());
        ...
        if ($request->hasFile('attachment')) {
            ...
            $data['attachment'] = str_replace(" ", "_", time() . '_' . $attachment_file->getClientOriginalName());
        ...
        if ($request->hasFile('main_attachment')) {
            ...
            $data['main_attachment'] = str_replace(" ", "_", time() . '_' . $attachment_file->getClientOriginalName());
...
//        $navigation = Navigation::find($id);
        ...
        if ($request->hasFile('icon_image')) {
            ...
            $data['icon_image'] = str_replace(" ", "_", time() . '_' . $icon_image->getClientOriginalName());
            $destinationPath = public_path('uploads/icon_image');
        ...
        if ($request->hasFile('featured_image')) {
            ...
            $data['featured_image'] = str_replace(" ", "_", time() . '_' . $icon_image->getClientOriginalName());
            $destinationPath = public_path('uploads/featured_image');
        ...
        if ($request->hasFile('banner_image')) {
            ...
            $data['banner_image'] = str_replace(" ", "_", time() . '_' . $banner_image->getClientOriginalName());
            $destinationPath = public_path('uploads/banner_image');
    ...
    {
        $navigations = Navigation::where('nav_category', $nav_category)->where('parent_page_id', $parent_id)->orderBy('position', 'ASC')->get();
        return view('admin.navigation.navigation_list', compact('navigations', 'nav_category'));
